...
public class SegmentTemplate extends AbstractTemplate<Segment> {
    ...
    @Override
    public Segment read(Unpacker unpacker, Segment segment, boolean required) throws IOException {
        ...
        segment.setStartTimestamp(unpacker.readLong());
        segment.setEndTimestamp(unpacker.readLong());
        ...
        unpacker.readArrayEnd();
        segment.setSegmentPoints(points);
        unpacker.readArrayEnd();
