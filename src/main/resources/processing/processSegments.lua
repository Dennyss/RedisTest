...
local createNewSegmentPackMessage = function(latitude, longitude, timestamp)
    ...
    local newSegment = {};
    newSegment[1] = timestamp;  -- Assume the first element will be startTimestamp
    newSegment[2] = timestamp;  -- Assume the second element will be endTimestamp
    newSegment[3] = latitude .. ":" .. longitude;
